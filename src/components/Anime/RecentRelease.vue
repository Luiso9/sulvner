...
import CustomLoading from "@/components/Anime/CustomLoading.vue";
...
export default {
	...
	computed: {
		...
		animeList() {
			return this.animeStore.recentAnime.results;
		},
		totalPages() {
			return this.animeStore.recentAnime.totalPages;
		},
		loading() {
	...
	methods: {
		async loadAnimeList() {
			await this.animeStore.fetchRecentAnime();
		},
		viewAnimeDetails(id) {
